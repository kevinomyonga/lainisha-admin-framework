...
class $AssetsImagesBrandingGen {
  ...
  /// File path: assets/images/branding/knoeyes_logo.png
  AssetGenImage get knoeyesLogo =>
      const AssetGenImage('assets/images/branding/knoeyes_logo.png');

  /// List of all assets
  List<AssetGenImage> get values => [knoeyesLogo];
}

class Assets {
  Assets._();

  static const String package = 'lainisha';
...
class AssetGenImage {
  ...
  String get keyName => 'packages/lainisha/$_assetName';
}
