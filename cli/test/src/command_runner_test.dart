...
import 'package:lainisha_cli/src/command_runner.dart';
import 'package:lainisha_cli/src/version.dart';
...
void main() {
  group('LainishaCliCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late LainishaCliCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = LainishaCliCommandRunner(
        logger: logger,
    ...
    test('can be instantiated without an explicit analytics/logger instance',
        () {
      final commandRunner = LainishaCliCommandRunner();
